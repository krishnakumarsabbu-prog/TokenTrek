...
router.get('/ai-insights', (_req, res) => { res.json((0, analytics_1.computeAIInsights)()); });
...
router.get('/marketplace', (_req, res) => {
    const storePrompts = db_1.store.prompts || [];
...
router.get('/reports', (_req, res) => {
    ...
    const totals = (0, analytics_1.computeTotals)();
    let cost_change = 0;
    let token_change = 0;
    let request_change = 0;
    let period_str = 'Recent Period';
    const dailyUsage = (0, analytics_1.computeDailyUsage)();
